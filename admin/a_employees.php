...
<html lang="en">
    <head>
        ...
        <title>KCCTS | SECURITY - DASHBOARD</title>
    ...
    <body>
         ...
         <div class="wrapper">
            ...
            <div id="content">
                ...
                <div clas="col-md-12">
                    <img src="assets/image/pic05.jpg" class="img-thumbnail">
                    </div>
                ...
                <div class="line"></div>
                            ...
                            $surname = mysqli_real_escape_string($mysqli,$_POST['surname']);
							  $dresident = mysqli_real_escape_string($mysqli,$_POST['dresident']);
							    $wresident = mysqli_real_escape_string($mysqli,$_POST['wresident']);
								 $dnum = mysqli_real_escape_string($mysqli,$_POST['dnum']);
								  $nid = mysqli_real_escape_string($mysqli,$_POST['nid']);
								  $nbulding = mysqli_real_escape_string($mysqli,$_POST['nbulding']);
                ...
                $sql = "INSERT INTO employees(name,surname,email,dresident,wresisent,dnum,nid,nbulding,joined,gender,phone,tmp,employee_id)VALUES('$name','$surname','$dresident','$wresisent','$dnum','$nid','$nbulding','$email','$joined','$gender','$phone','$tmp','$employee_id')";
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading">KCCTS SMS Add New resident</div>
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Surname</label>
			  ...
			  <div class="col-lg-6">
            <label>district of resident</label>
              <input type="text" class="form-control" name="surname" pattern="[A-Za-z]{3,}" required>
            </div>
			  <div class="col-lg-6">
            <label>ward of resident</label>
              <input type="text" class="form-control" name="surname" pattern="[A-Za-z]{3,}" required>
            </div>
			<div class="col-lg-6">
            <label>name of bulding resident</label>
              <input type="text" class="form-control" name="surname" pattern="[A-Za-z]{3,}" required>
            </div>
			  <div class="col-lg-6">
            ...
            <label>Gender</label>
             <select class="form-control" name="gender">
              ...
              <option>M</option>      
                ...
                <footer>
            <p class="text-center">
           KISII COUNTY CRIME TRACKING SYSTEM &copy;<?php echo date("Y ");?>Copyright. All Rights Reserved, Powered By KIBOMA Systems    
            </p>
            </footer>
            </div>
